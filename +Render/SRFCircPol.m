...
addParameter(p, 'rabi', 100, @isnumeric);
addParameter(p, 'rf', 100, @isnumeric);
...
for i=1:length(thetas)
    ...
    [ F, B ] = MRF.MeshedQuasiEnergies(Bs, RF, Rabi, 'iterations', p.Results.iterations, 'qdrpGrad', 0, 'F', 1, 'theta', theta);
