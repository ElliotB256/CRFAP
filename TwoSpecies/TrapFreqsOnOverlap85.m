...
for i=1:length(thetas)
    theta = thetas(i);
     ...
     [ F, B ] = MRF.MeshedQuasiEnergies(zeemanSplit, RFs, 2/3*[gFuBB1_87 gFuBB2_87]', 'iterations', 4, 'qdrpGrad', QdrpGrad, 'F', 2, 'theta', theta);
...
freqs = Util.getTrapFreq(s, minv-minv(1), 85);
